# OS Updater (Android App) ![Android CI][badge-ci] [![latest release][badge-latest-release]][github-ou-releases]
...
The app targets API 37 (Android 17), with a minimum API level of 23 (Android 6/Marshmallow). Make sure both SDK platforms (and optionally sources) are installed via SDK Manager.
