...
The app targets API 36 (Android 16/W), with a minimum API level of 21 (Android 5/Lollipop). Make sure both SDK platforms (and optionally sources) are installed via SDK Manager.
...
[badge-latest-release]: https://img.shields.io/badge/release-v6.7.4-%23f50514?logo=github
