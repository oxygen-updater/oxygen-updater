...
public class NotificationTopicSubscriber {
    ...
    public static void subscribe(ApplicationData data) {
        ...
        String newTopic = NOTIFICATIONS_PREFIX + DEVICE_TOPIC_PREFIX + settingsManager.getPreference(PROPERTY_DEVICE_ID, -1L) + UPDATE_METHOD_TOPIC_PREFIX + settingsManager.getPreference(PROPERTY_UPDATE_METHOD_ID, -1L);
