...
class MessageBottomSheetDialog : BottomSheetDialogFragment() {
    ...
    fun setTitle(title: String?): MessageBottomSheetDialog {
        this.title = title
        return this
    }

    fun setMessage(message: String?): MessageBottomSheetDialog {
        this.message = message
        return this
    }

    fun setDialogListener(listener: DialogListener?): MessageBottomSheetDialog {
        dialogListener = listener
        return this
    }

    fun setPositiveButtonText(positiveButtonText: String?): MessageBottomSheetDialog {
        this.positiveButtonText = positiveButtonText
        return this
    }

    fun setNegativeButtonText(negativeButtonText: String?): MessageBottomSheetDialog {
        this.negativeButtonText = negativeButtonText
        return this
    }

    fun setClosable(closable: Boolean): MessageBottomSheetDialog {
