 ...
 * the object while an asynchronous operation is in progress. You can call {@link
 * #disposeWhenFinished()} to ensure that any in-progress operation completes before the object is
 * disposed.
 * <p>
