...
class BottomSheetPreference : Preference {
    ...
    fun setValueIndex(selectedIndex: Int) {
        ...
        if (changed || !valueSet) {
            ...
            if (changed) { // redraw previous selected and new selected layouts
    ...
    fun setSecondaryKey(secondaryKey: String?) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating secondaryKey: %s", secondaryKey))
        this.secondaryKey = secondaryKey
    }

    override fun setTitle(title: CharSequence) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating dialog title: %s", title))
    ...
    fun setCaption(caption: String?) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating dialog caption: %s", caption))
        this.caption = caption
        setText(dialogLayout.findViewById(R.id.dialog_caption), caption)
    }

    fun setEntries(entries: Array<CharSequence>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating titles for %d items", entries.size))
    ...
    fun setTitleEntries(titles: Array<CharSequence>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating titles for %d items", titles.size))
    ...
    fun setSubtitleEntries(subtitles: Array<CharSequence>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating subtitles for %d items", subtitles.size))
    ...
    fun setEntryValues(entryValues: Array<CharSequence>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating entryValues for %d items", entryValues.size))
    ...
    fun setSecondaryEntryValues(objectEntryValues: Array<Any?>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Updating secondaryValues for %d items", objectEntryValues.size))
    ...
    fun setItemList(itemList: List<BottomSheetItem>) {
        Logger.logInfo(TAG, String.format(Locale.getDefault(), "Populating itemList with %d items", itemList.size))
