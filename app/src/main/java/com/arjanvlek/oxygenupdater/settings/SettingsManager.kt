...
class SettingsManager(private val context: Context?) {
    ...
    fun <T> getPreference(key: String, defaultValue: T): T {
        ...
        return if (preferences == null) defaultValue else if (preferences.contains(key)) preferences.all[key] as T else defaultValue
    }
    ...
    fun deletePreference(key: String) {
        val editor = sharedPreferencesEditor
