...
import com.arjanvlek.oxygenupdater.BuildConfig.SERVER_BASE_URL
...
import com.arjanvlek.oxygenupdater.internal.server.ServerRequest.RequestMethod.GET
import com.arjanvlek.oxygenupdater.internal.server.ServerRequest.RequestMethod.POST
...
internal enum class ServerRequest(val requestMethod: RequestMethod, private val url: String, val timeOutInSeconds: Int, val returnClass: Class<*>) {

    DEVICES("devices", Device::class.java),
    ...
    NEWS_READ(POST, "news-read", ServerPostResult::class.java),

    SUBMIT_UPDATE_FILE(POST, "submit-update-file", ServerPostResult::class.java),
    LOG_UPDATE_INSTALLATION(POST, "log-update-installation", ServerPostResult::class.java),

    VERIFY_PURCHASE(POST, "verify-purchase", 120, ServerPostResult::class.java);

    constructor(url: String, returnClass: Class<*>) : this(url, DEFAULT_TIMEOUT, returnClass) {}

    constructor(url: String, timeOutInSeconds: Int, returnClass: Class<*>) : this(GET, url, timeOutInSeconds, returnClass) {}
