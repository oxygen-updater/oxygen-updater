...
public class CustomDropdown {
	...
	public static View initCustomThemeDropdown(int currentPosition, View convertView, ViewGroup parent, @LayoutRes int layoutType, List<String> themes, int recommendedPosition,
	                                           Context context) {
		if (convertView == null) {
		...
		textView.setText(themes.get(currentPosition));
