...
public class UpdateDataVersionFormatter {
    ...
    /**
     * Checks if the passed update version information contains a version number which can be formatted
     * @param versionInfo Update version information to check
     * @return Whether or not this update version information contains a version number which can be formatted.
     */
    ...
    /**
     * Get the formatted version number of the passed update version information.
     * The output is as following:
     * Regular update: "Oxygen OS 4.0.0"
     * Open Beta update: "Oxygen OS Open Beta 28"
     * Other update with "(#)OS Version": "OS Version: Windows 10 1709"
     * Update without "(#)OS Version": "V. OnePlus5TOxygen_23_1804231200"
     * Null versionInfo / no internal version number in versionInfo: "Oxygen OS System Update"
    ...
    public static String getFormattedVersionNumber(FormattableUpdateData versionInfo) {
        if (!canVersionInfoBeFormatted(versionInfo)) {
            return versionInfo != null && versionInfo.getInternalVersionNumber() != null && !versionInfo.getInternalVersionNumber().equals("") ? "V. " + versionInfo.getInternalVersionNumber() : "Oxygen OS System Update";
        }
     ...
     * @return The first line of the update description of the given Version Info, or the empty string if the update description is null or empty.
     */
