...
val Symbols.ExpandCircleDown: ImageVector
    get() = _expandCircleDown ?: materialSymbol(
        name = "ExpandCircleDown",
    ) {
        moveToRelative(480.0f, 507.0f)
        lineToRelative(-95.0f, -95.0f)
        quadToRelative(-11.0f, -11.0f, -27.5f, -11.0f)
        reflectiveQuadTo(329.0f, 412.0f)
        ...
        reflectiveQuadTo(631.0f, 412.0f)
        quadToRelative(-12.0f, -11.0f, -28.0f, -11.5f)
        reflectiveQuadTo(575.0f, 412.0f)
        lineToRelative(-95.0f, 95.0f)
        close()
        ...
        close()
    }.also { _expandCircleDown = it }

private var _expandCircleDown: ImageVector? = null

@Preview
@Composable
private fun Preview() = PreviewIcon(Symbols.ExpandCircleDown)
