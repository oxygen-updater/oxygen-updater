...
val Symbols.MobileLockPortrait: ImageVector
    get() = _mobileLockPortrait ?: materialSymbol(
        ...
        close()
    }.also { _mobileLockPortrait = it }

private var _mobileLockPortrait: ImageVector? = null

@Preview
@Composable
private fun Preview() = PreviewIcon(Symbols.MobileLockPortrait)
