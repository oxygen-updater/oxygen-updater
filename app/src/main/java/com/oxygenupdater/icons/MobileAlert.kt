...
val Symbols.MobileAlert: ImageVector
    get() = _mobileAlert ?: materialSymbol(
        name = "MobileAlert",
    ) {
        ...
        close()
    }.also { _mobileAlert = it }

private var _mobileAlert: ImageVector? = null

@Preview
@Composable
private fun Preview() = PreviewIcon(Symbols.MobileAlert)
