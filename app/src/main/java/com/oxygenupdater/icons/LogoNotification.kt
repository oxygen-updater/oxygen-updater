...
val CustomIcons.LogoNotification: ImageVector
    get() {
        if (_logoNotification != null) return _logoNotification!!
        _logoNotification = materialIcon("LogoNotification") {
            materialPath {
                moveTo(12f, 0f)
                lineTo(12f, 0f)
...
@Preview
@Composable
private fun Preview() = PreviewIcon(CustomIcons.LogoNotification)
