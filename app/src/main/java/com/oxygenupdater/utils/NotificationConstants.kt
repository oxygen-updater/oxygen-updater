...
object NotificationChannels {
    ...
    object DownloadAndInstallationGroup {
         ...
         */
        const val DOWNLOAD_STATUS_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.download"
         ...
         */
        const val VERIFICATION_STATUS_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.verification"

        /**
         * Name: Installation status
         * Description: Get notified if an update was successfully installed or not
         */
        const val INSTALLATION_STATUS_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.installation"
    }
    ...
    object PushNotificationsGroup {
         ...
         */
        const val UPDATE_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.update"

        /**
         * Name: News article published
         * Description: Get notified when we publish a news article
         */
        const val NEWS_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.news"

        /**
         * Name: New device supported
         * Description: Get notified when the app adds support for a new device
         */
        const val DEVICE_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.device"

        /**
         * Name: General
         * Description: General notifications that don't fit into other categories
         */
        const val GENERAL_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.general"
    }
    ...
    object MiscellaneousGroup {
         ...
         */
        const val OTA_FILENAME_SUBMITTED_NOTIFICATION_CHANNEL_ID = "com.oxygenupdater.notifications.filename"
    }
