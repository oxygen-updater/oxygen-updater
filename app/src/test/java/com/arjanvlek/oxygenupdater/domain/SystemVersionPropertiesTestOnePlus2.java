...
public class SystemVersionPropertiesTestOnePlus2 extends SystemVersionPropertiesTest {
    ...
    public void testSupportedDevice_OxygenOS200() {
        // Not supported in app versions 1.2.x - 2.2.x, but has been fixed in 2.3.x
        Assert.assertTrue(isSupportedDevice("op2", "2.0.0", "OnePlus2", NO_OXYGEN_OS, "OnePlus2", "OnePlus2Oxygen_14_1507251956", "OnePlus2Oxygen_14.A.02_GLO_002_1507251956", false));
    }
